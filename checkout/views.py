...
def checkout_success(request, order_number):
    ...
    if request.user.is_authenticated:
        ...
        if save_info:
            # If the save info box has been checked we create a dictionary
            # With these details to save as the user's defaults
            profile_data = {
            ...
            # Initialize an instace of the UserProfileForm
